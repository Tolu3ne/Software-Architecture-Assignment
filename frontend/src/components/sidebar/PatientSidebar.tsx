    ...
    <div style={styles.container}>
      <div style={styles.sidebar}>
        ...
        <nav style={styles.nav}>
          <Link to="/patient" style={styles.navItem}>Registeration</Link>
          <Link to="/patient" style={styles.navItem}>Book Appointment</Link>
          <Link to="/patient" style={styles.navItem}>Payment</Link>
        </nav>
