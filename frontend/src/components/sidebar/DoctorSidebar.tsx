    ...
    <div style={styles.container}>
      <div style={styles.sidebar}>
        ...
        <nav style={styles.nav}>
          <Link to="/doctor" style={styles.navItem}>Patient Management</Link>
          <Link to="/doctor" style={styles.navItem}>Schedule Appointment</Link>
          <Link to="/doctor" style={styles.navItem}>Settings</Link>
        </nav>
